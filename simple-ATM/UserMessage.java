...
public class UserMessage {
    ...
    public void write(String[] message) throws IOException {
        ...
        out.write(sb.toString().getBytes("utf-8"));         //将字符串流中的信息写入文本
        out.close();            //关闭
    }
    ...
    public String updatemoney(String countname, int wangsave) throws IOException {
         ...
         * 但重新创建文件对象，则可以完成操作
         */
        File file1 = new File("d:/Message.txt");   //重新建立文件对象， 覆盖写入文本
        if (!file1.exists())
            file1.createNewFile();
    ...
    public String updatepwd(String countname, String pwd) throws IOException {
         ...
         * 但重新创建文件对象，则可以完成操作
         */
        File file1 = new File("d:/Message.txt");
        if (!file1.exists())
            file1.createNewFile();
