...
public interface SerialNumberMapperEx {
    ...
    /**
     * 卖出： update feiying_serial_number set is_Sell='1' ,depothead_Id='depotheadId' where 1=1 and material_Id='materialId'
    ...
    /**
     * 赎回：update feiying_serial_number set is_Sell='0'  where 1=1 and material_Id='materialId'
