...
import com.feiying.erp.datasource.mappers.AccountHeadMapperEx;
import com.feiying.erp.datasource.mappers.DepotHeadMapperEx;
import com.feiying.erp.datasource.mappers.SupplierMapper;
import com.feiying.erp.datasource.mappers.SupplierMapperEx;
import com.feiying.erp.exception.BusinessRunTimeException;
import com.feiying.erp.service.accountHead.AccountHeadService;
import com.feiying.erp.service.depotHead.DepotHeadService;
...
import static com.feiying.erp.utils.Tools.getNow3;
...
public class SupplierService {
    ...
    public int batchDeleteSupplierByIdsNormal(String ids) throws Exception {
        /**
         * 校验
         * 1、财务主表	feiying_accounthead
         * 2、单据主表	feiying_depothead
         * 是否有相关数据
         * */
        int deleteTotal=0;
