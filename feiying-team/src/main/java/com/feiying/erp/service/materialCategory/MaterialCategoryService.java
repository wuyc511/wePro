...
import com.feiying.erp.datasource.mappers.MaterialCategoryMapper;
import com.feiying.erp.datasource.mappers.MaterialCategoryMapperEx;
import com.feiying.erp.datasource.mappers.MaterialMapperEx;
...
public class MaterialCategoryService {
    ...
    public int batchDeleteMaterialCategoryByIdsNormal(String ids) throws Exception {
        /**
         * 校验
         * 1、产品表	feiying_material
         * 2、产品类型表	feiying_materialcategory
         * 是否有相关数据
         * */
        int deleteTotal=0;
        ...
        /**
         * 校验产品类型表	feiying_materialcategory
         * */
