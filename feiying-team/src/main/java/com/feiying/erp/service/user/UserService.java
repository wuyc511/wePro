...
import com.feiying.erp.datasource.entities.UserExample;
import com.feiying.erp.datasource.mappers.UserMapper;
import com.feiying.erp.datasource.mappers.UserMapperEx;
...
import com.feiying.erp.service.orgaUserRel.OrgaUserRelService;
import com.feiying.erp.service.tenant.TenantService;
import com.feiying.erp.service.userBusiness.UserBusinessService;
import com.feiying.erp.utils.ExceptionCodeConstants;
import com.feiying.erp.utils.feiyingException;
import com.feiying.erp.utils.StringUtil;
import com.feiying.erp.utils.Tools;
...
public class UserService {
    ...
    public int validateUser(String username, String password) throws feiyingException {
        try {
            /**默认是可以登录的*/
            List<User> list = null;
            try {
            ...
            throw new feiyingException("unknown exception", e);
        }
    }
