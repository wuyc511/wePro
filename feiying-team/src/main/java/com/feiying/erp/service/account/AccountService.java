...
import com.feiying.erp.datasource.mappers.*;
import com.feiying.erp.datasource.vo.AccountVo4InOutList;
import com.feiying.erp.datasource.vo.AccountVo4List;
...
public class AccountService {
    ...
    public int batchDeleteAccountByIdsNormal(String ids) throws Exception{
         ...
         * 2、财务子表	feiying_accountitem
         * 3、单据主表	feiying_depothead
         * 是否有相关数据
         * */
        int deleteTotal=0;
